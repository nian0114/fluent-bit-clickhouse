...
func GetTimeKey(ctx unsafe.Pointer) string {
	return output.FLBPluginConfigKey(ctx, "time_key")
}

func GetTimeFormat(ctx unsafe.Pointer) string {
	return output.FLBPluginConfigKey(ctx, "time_format")
}
